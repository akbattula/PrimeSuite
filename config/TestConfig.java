...
import com.connect.data.handlers.GetDataFromProperties;
...
public class TestConfig {
	...
	public static WebDriver getDriverInstance() {
		...
		String browser= com.connect.data.handlers.GetDataFromProperties.getDataFromProperties("C:\\MyPersonalWork\\SeleniumWorkSpace\\TheWolverine\\test-config\\config.properties","browser");
	...
	public static String applicationURL() {
		String url=com.connect.data.handlers.GetDataFromProperties.getDataFromProperties("C:\\MyPersonalWork\\SeleniumWorkSpace\\TheWolverine\\test-config\\config.properties","ApplicationURL");
		return url;
	}
